...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <p>Question 1: Where Niagara Falls is located</p>
    <div style="display: flex; flex-direction: column;">
        <div style="display: flex; flex-direction: row;">
            <input id="first" type="radio" name="question1" value="Canada"> <label for="first">Japanese dollar</label></div>
        <div style="display: flex; flex-direction: row;">
            <input id="first" type="radio" name="question1" value="USA"> Yen
        </div>
        <div style="display: flex; flex-direction: row;">
            <input id="first" type="radio" name="question1" value="Aliasca"> Yuan
        </div>
    </div>
    <br><br>
